...
def main():
    ...
    protected = [args.out/"manifest.json", args.out/"all_candidate_screen.json"]
    if any(path.exists() for path in protected):
        raise FileExistsError("Completed audit outputs already exist; choose a new --out directory")
