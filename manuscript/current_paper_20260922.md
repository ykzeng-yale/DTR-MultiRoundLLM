...
| E12 has instrument evidence but no delivered model outcomes | [Accepted validation](../docs/e12_validation_acceptance_20260922.md); 42 reference/control starts are not prompt-efficacy observations. The current checkpoint records accepted scheduling and a repaired startup attempt, without E12 outcome evidence. |
