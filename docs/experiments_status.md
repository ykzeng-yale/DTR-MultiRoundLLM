...
**Last updated: 2026-09-25T17:50:28Z** — **Full rebuild of this page (sections 0–8) from verified primary sources.** Last lead commit processed: `53fe1342dae6258adb10b092d2bdec20dc85a4f5` (LEAD-POLICY-12, accepted). Watcher: **running**, re-armed each tick, wakes on every lead commit and at most every 30 min while this desktop session is open; the separate half-hourly scheduler has not fired since 2026-09-23T08:10:19Z. Run/lease: **none**. E14 N1/S1 batch: **NO-GO accepted** (LEAD-POLICY-06). Next bounded action: none open on the worker side; **blocker** for any experiment work is a new lead-owned development design (§0).
