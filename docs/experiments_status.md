...
**Last updated: 2026-09-23T07:22:00Z** — **MRL-22 running** (source-only, deadline 07:42Z): reviewing exactly frame ranks 21-40 under the original criteria plus a corrected E14 proposal. **E14's nine-root roster is withdrawn** — I refuted it pre-collection (published before the lead's matching ruling): those roots are E12's nine public-pass roots, all **9/9 already passing privately**, every DIRECTED request degenerating to the same `S1_STRINGS[2]` preservation string, and E12 already recorded N1 9/9 vs S1 9/9 there. Built artifacts retained: 108-slot plan (`results/e14_request_plan_20260923.json`, 13 tests) and roster audit (14/14 checks, 6 tests). I also withdrew a real sizing error of mine: at 6 draws the within-root term is 2x0.25/6 = 0.08333, so more replicates DO shrink it. E13a's −0.100 and its archive acceptance stand. Suite 1,133 passed. No receiver time spent this cycle.
