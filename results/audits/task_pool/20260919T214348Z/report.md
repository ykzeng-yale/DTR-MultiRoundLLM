...
Run 20260919T214348Z, 3.12.13, sandbox `seatbelt`, 4 workers, 18.2 s.
...
| S5 | at most 1% of tasks are passed by a do-nothing stub (those are excluded) | yes |
| S6 | no task has >= 60% of its solution body already visible | yes |
