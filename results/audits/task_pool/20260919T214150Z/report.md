...
Run 20260919T214150Z, 3.12.13, sandbox `seatbelt`, 4 workers, 17.4 s.
...
| S6 | median share of the reference already visible | 0.1789 |
| S6 | tasks with >= 60% of the reference already visible | 149 |
| — | **usable tasks** | **590** |
| — | excluded | 1 |
